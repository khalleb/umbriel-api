...
import { IPagination, IPaginationAwareObject, paginate } from '../../core/Pagination';
import { EntityBase } from '../../entities/postgres/EntityBase';
...
export default class BaseRepository<T> implements IBaseRepository<T> {
  ...
  public async delete(id: string | string[]): Promise<DeleteResult> {
